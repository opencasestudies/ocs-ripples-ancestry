...
* Enter `=ARRAYFORMULA(REDUCE(A1:A1914, SEQUENCE(ROWS('Pop Index'!A1:A5)), LAMBDA(current_list, row_num, SUBSTITUTE(current_list, INDEX('Pop Index'!A1:A5, row_num), INDEX('Pop Index'!B1:B5, row_num)))))` in B1.
