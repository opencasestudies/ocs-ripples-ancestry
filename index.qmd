...
<!--
Possible addition given Hanako's concern that this section isn't long enough?
Questions such as "What is the human genome?", "What is genomic variation?", and "Why should we care about human genomic variation?" will be discussed. Data representing genomic variation and ancestry will be examined and ways to represent or visualize this data will be highlighted. In addition, ways to work with large amounts of data will be compared and contrasted, showing more manual approaches and more general processing through computational work.
-->

## What is the human genome?

The human {{< glossary genome add_to_table=true >}} (all of an individual's DNA) is made of stretches of {{< glossary nucleotides display = "nucleotides (A,C,G,T)" add_to_table=true >}}. The nucleotides ultimately encode for {{< glossary protein add_to_table=true >}} products that function in the body in important ways. Proteins include enzymes like amylase to break down food, peptide hormones such as insulin to regulate blood sugar, and structural proteins such as keratin in skin and nails. An individual's genome encodes all the {{< glossary proteins add_to_table=true >}} they need for their body to function normally.

## What is genomic variation?

Most of a person's genome is the same as another person's. All humans need the same proteins to function. But very small parts of our genome, especially in areas that do not code for proteins, can vary across individuals. This genomic variation is caused by changes in the nucleotide sequences that can cause differences in how a protein functions or the amount of protein created. Some variations can change the function of a protein so severely that it stops doing its intended function, while others can increase or decrease the amount of protein that is produced.
...
These variations in a genome are caused by mutations. Mutations are any changes in the DNA or nucleotides that make up the genome. These variations can be caused by a change of a single nucleotide ("point mutations") or changes involving more than one nucleotide.
...
<details><summary>The Central Dogma</summary>

Add summary here for the Central Dogma, including terms with defintions for
...
* Transcription
* Translation
* {{< glossary codon add_to_table=true >}}
* tRNA Anticodon
...
library(tidyverse)
library(ggplot2)
install.packages(c("patchwork", "ggforce"), repos="https://cloud.r-project.org/")
library(patchwork)
