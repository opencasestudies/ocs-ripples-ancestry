...
#ancestry_props <- read_table("~/Documents/resources/papers/ripples/NC.admixture_results.with_fam.Q", col_names = c("pop", "id", paste0("k", 1:7)))
ancestry_props <- 
  read_table("~/course_repos/OCS/ocs-ripples-ancestry/data/raw/AGR.without_related_chr10_maf001_LDp50_final_removesmallpops_shrinkBaganda.combined_fam.Q", col_names = c("pop", "id", paste0("k", 1:7)))
...
ancestry_props_prelim %>% 
  ...
  print(n=26) %>% write_csv( "~/course_repos/OCS/ocs-ripples-ancestry/data/wrangled/ancestry_prop_avg.csv")
```
