...
These variations can be caused by a change of a single nucleotide ("point mutations") or changes involving more than one nucleotide. An example of a single nucleotide change would be changing a base from C → T or adding or removing a single nucleotide.
...
<details><summary>More details about dotplots</summary>
...
|:--------------|:------------------------:|:-----------------:|:-----------------------------------------------------------------------:|
| Silent        | Substitution             |                   |                                                                         |
| Synonymous    | Substitution             |                   | :white_check_mark:                                                      |
| Missense      | Substitution             | :white_check_mark:| :white_check_mark:                                                      |
...
: Single Nucleotide Mutations Summary Table {.bordered}
