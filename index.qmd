...
1) **pop:** A column about the population where a sample came from, with values like Egyption or British.
...
This is really powerful beacuse instead of going in and replacing every value where these occured by hand, we can do it very quickly in R and we have a record of how we changed the data.
