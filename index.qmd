...
A single nucleotide insertion or deletion (or one that is a length not a multiple of three -- 3 is the length of a codon) may introduce a **frameshift mutation**. Frameshift mutations often impact the structure and function of proteins because of the shifting of the reading frame during translation for all subsequent codons after the insertion or deletion.

{{< video https://www.youtube.com/watch?v=xYOK-yzUWSI&t=162s >}}

| Mutation Type | Nucleotide Change | Amino Acid Change | Protein Abundance Change (Possibly) | Protein Function Change (Possibly) |
|:--------------|:-----------------:|:-----------------:|:-----------------------------------:|:----------------------------------:|
| Silent        | X                 |                   |                                     |                                    |
| Synonymous    | X                 |                   | X                                   | X                                  |
| Missense      | X                 | X                 | X                                   | X                                  |
| Missense - Conservative| X        | X                 | ?                                   | ?                                  |
| Missense - Non-conservative| X    | X                 | X                                   | X                                  |
| Nonsense      | X                 | Stop Codon        | X                                   | likely non-functional              |
| Frameshift    | indels mostly     | Lots              | X                                   | X                                  |
