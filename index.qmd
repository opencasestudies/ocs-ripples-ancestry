...
If you needed to order / sort values ...
...
Unlike in R, Google Sheets prefers the data is in a wide format when making graphs, so transforming wide data to long data is not necessary for the data visualization steps of this case study. 
