...
If you needed to filter out rows, you can again use a formula. 

* Click the `+` (Add Sheet) button on the bottom left of the Google Sheet.
* Name the new sheet 'Testing Filter 1'.
* Give an example of filtering based on observing a value.
* Note that the headers are not brought over in this example.

* Click the `+` (Add Sheet) button on the bottom left of the Google Sheet.
* Name the new sheet 'Testing Filter 2'.
* Give an example of filtering based on not observing a value.
* Note that the headers are brought over in this example.

* Click the `+` (Add Sheet) button on the bottom left of the Google Sheet.
* Name the new sheet 'Testing Filter 3'.
* Give an example of filtering based on not observing either of two values.
...
If you needed to rearrange or transform the data from a long format to a wide format ...
